package com.chao.helper.utils.sqlgeneratetool;
...
public class EntityGenerateTool {
	...
	// 数据库连接
	private static final String URL = "jdbc:mysql://10.34.200.216:3306/qghx?useUnicode=true&characterEncoding=UTF-8";
