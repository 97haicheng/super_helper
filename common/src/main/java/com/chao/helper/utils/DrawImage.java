...
import com.chao.helper.utils.verificationcode.ValidateCode;
...
public class DrawImage {
    ...
    public DrawImage(HttpServletRequest request,HttpServletResponse response){
