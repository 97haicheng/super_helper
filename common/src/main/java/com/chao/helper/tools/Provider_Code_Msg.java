...
public class Provider_Code_Msg {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            sql = "select * from code_sdlt_code_msg";
            ResultSet rs = stmt.executeQuery(sql);// executeQuery会返回结果的集合，否则返回空值
            while (rs.next()) {
//                Thread.sleep(5000);
                //子表
//                System.out.println("SDLT_"+rs.getString(2)+"(\""+rs.getString(2)+"\",\"SDLT_"+rs.getString(2)+"\"),");
                //总表
                System.out.println("SDLT_"+rs.getString(2)+"(\"SDLT_"+rs.getString(2)+"\",\""+rs.getString(3)+"\"),");
            }
