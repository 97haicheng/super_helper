package com.chao.helper.tools.redis;
...
//        backups("C:\\Users\\Administrator\\Desktop\\redis.txt", get("#string:sms:verify.code:15840043215:1"));
        dataTransfer("#string:sms:verify.code");
